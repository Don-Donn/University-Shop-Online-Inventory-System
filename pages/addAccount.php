...
?>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['addButton'])) {
        // Retrieve form data
        $empcode = mysqli_real_escape_string($con, $_POST['EC']);
        ...
        if ($password != $confirmPassword) {
            ...
            $insertEmpDataQuery = "INSERT INTO emp_data (empCode, User_Type, User_Email, User_Password) VALUES ('$empcode', '$usertype', '$email', '$password')";
